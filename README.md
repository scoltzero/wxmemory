...
> 微信聊天记录归档工具 — 将微信对话导出为 Markdown，支持语音转写、图片、视频等多媒体内容。
>
> 本工具的初衷是为了让微信的聊天记录能够顺利的被本地保存下来，保存自己的记忆。仅供个人使用交流和学习。
>
> P.S.  闭源收费的原因很简单，想让项目的寿命长一点。因为不保证项目永久有效，故无永久高级授权。
>
> 现阶段高级功能还在测试阶段，不保证 100% 的成功率，故请理性充电。对于大部分语音文字消息，已经可以无损导出了。
...
| 设备 | 推荐分辨率 |
|------|-----------|
| MacBook Pro 14'' | 1800 × 1169 |
| MacBook Pro 16'' | 2056 × 1329 |
| MacBook Air 13'' | 1710 × 1112 |
| MacBook Air 15'' | 1903 × 1236 |
| 4K / 5K 外接显示器 | 2304 × 1296 |
